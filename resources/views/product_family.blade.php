...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#datatables').DataTable({
            ...
            ajax: '{{ route('product_family.getAll') }}',
            columns: [
                { data: 'name',name: 'name'},
                ...
                { data: 'id',name: 'id', 
                    render: function ( data, type, row, meta ) {
                        var editHref = '{{ route("product_family.edit") }}';
                        var deleteHref = '{{ route("product_family.delete") }}';
    ...
    $("#form_add").on('submit', function(e){
        if("{{ $permission['i'] }}" === 'true'){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '{{ route("product_family.store") }}',
    ...
    $("#form_edit").on('submit', function(e){
        if("{{ $permission['i'] }}" === 'true'){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '{{ route("product_family.update") }}',
                data: new FormData(this),
                contentType: false,
                cache: false,
                processData:false,
