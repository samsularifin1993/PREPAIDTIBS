...
<script>
    ...
    $(document).ready(function() {
        ...
        datatables = $('#datatables').DataTable({
            ...
            ajax: '{{ route('report.getAllByProduct') }}',
            columns: [
    ...
    function getData(month, year){
        ...
        datatables.ajax.url('{{ route('report.getAllByProduct') }}'+'?month='+month.toString()+'&year='+year.toString()).load();
    }
</script>
@endsection