...
class CreateTransactionRejectedsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_rejecteds', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('transaction_rejecteds');
    }
}
